...
/// without that signal the assertion would only prove the second message had not been processed yet.
/// </summary>
internal sealed class ConsumeCounter : IConsumeObserver
{
    ...
    {
        ReadingsIngested readings => readings.MessageId,
        IngestAttemptRecorded attempt => attempt.MessageId,
        _ => null,
    };
