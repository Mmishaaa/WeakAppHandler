...
/// cares about instead of for a fixed sleep. The polling loop keeps running while the test waits,
/// so more than one batch may arrive; matching on batch id is what keeps the assertions exact.
/// </summary>
